...
trajectory_[100:, :] *= 0.0
trajectory_[50:150, 2] = np.min(trajectory_[:100, :])
trajectory_[150:, 0] = -np.min(trajectory_[:100, :])
np.save(os.path.join(script_path, '..', 'data-motion-2', 'eef_v_trajectory_test.npy'), trajectory_)
