...
material_id = 2
env = ClayEnv(ptcl_density=3e7, horizon=20,
...
env.mpm_env.simulator.system_param[None].yield_stress = yield_stress
env.mpm_env.simulator.particle_param[material_id].mu = mu
env.mpm_env.simulator.particle_param[material_id].lamda = lamda
