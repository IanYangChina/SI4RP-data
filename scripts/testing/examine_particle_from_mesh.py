...
if __name__ == '__main__':
    ...
    parser.add_argument('--motion', type=str, default='poking-1', help='Name of the motion used to collect the points for reconstructing the mesh: poking-1, poking-2, poking-shifting-1, poking-shifting-2')
