        ...
        for data_ind in data_ids:
            ...
            for i in range(len(E_list)):
                for j in range(len(yield_stress_list)):
                    set_parameters(mpm_env, env_cfg['material_id'],  E_list[i], nu=nu,
                                   yield_stress=yield_stress_list[j], rho=rho,
...
for i in range(len(losses)):
    ...
    plot_loss_landscape(E, yield_stress, losses[i], fig_title=fig_title,
                        ...
                        view='right',
                        x_label='E', y_label='yield_stress', z_label='Loss', hm=True, show=False)
